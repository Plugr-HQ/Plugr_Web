...
//
// BankSetup now lives in its own file (BankSetup.tsx) — shared with SettingsScreen's payout
// section, which previously had its own stripped copy with no PIN step at all.

'use client';

import { useCallback, useEffect, useRef, useState } from 'react';
import { Loader2, Lock, Clock, Check, Landmark, X, Wallet as WalletIcon } from 'lucide-react';
