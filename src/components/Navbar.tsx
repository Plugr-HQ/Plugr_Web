    ...
    <> {/* <--- Open React Fragment here */}
      <nav className="fixed top-0 w-full z-50 px-6 py-4 flex justify-between items-center bg-[#F5F1EC]">
        ...
        <div className="flex flex-row items-center gap-6 text-sm font-semibold text-[#0A1529]">
          <Link href="/auth/login" className="text-[#DBA134] px-12 py-3 rounded-full hover:text-[#DBA134] hover:bg-[#0A1529]/90 transition-colors">Log in</Link>
          <Link href="/auth/signup" className="bg-[#DBA134] text-white px-12 py-3 rounded-full hover:text-[#DBA134] hover:bg-[#0A1529]/90 transition-colors">Sign up</Link>
        </div>
