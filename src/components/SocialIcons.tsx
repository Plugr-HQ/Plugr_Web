function SocialIcons() {
    return (
        <div className="flex items-center gap-4 bg-pitch-black p-6">

            {/* X (formerly Twitter) */}
            <a
                href="https://x.com/getplugr"
                target="_blank"
            ...
            {/* LinkedIn */}
            <a
                href="https://www.linkedin.com/company/getplugr/"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-[#333230] flex items-center justify-center text-white hover:bg-[#444341] transition-colors duration-200"
            >
            ...
            <a
                ...
                className="w-10 h-10 rounded-full bg-[#333230] flex items-center justify-center text-white hover:bg-[#444341] transition-colors duration-200"
            >
                <svg className="w-5 h-5 stroke-current fill-none" strokeWidth="2" viewBox="0 0 24 24" aria-hidden="true">
