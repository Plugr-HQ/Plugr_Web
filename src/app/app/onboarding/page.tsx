...
//
// /app/onboarding/verify (the old standalone NIN screen) is also retired. Its screen and write
// path were deleted and the route now redirects to the Verification Hub (/app/plug/verification),
// which is where identity verification starts.
