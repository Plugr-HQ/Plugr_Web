...
// wallet view. Proxies to the guarded NestJS backend GET /plugs/:id, forwarding the token.
//
...
export async function GET(
  ...
  // Forward to the backend, passing the caller's bearer token for the guards.
